...
Revision ID: a5102c498de7
Revises: 4649d43e7def
Create Date: 2018-05-14 11:41:13.443763
...
revision = 'a5102c498de7'
down_revision = '4649d43e7def'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('inner_id', sa.String(length=20), nullable=True),
